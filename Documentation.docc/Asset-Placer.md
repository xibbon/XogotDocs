...
1. Open a 3D scene.
2. Open the bottom panel Asset Browser tab.
...
@Image(source: "AssetPlacerOverview.png",
       alt: "Xogot's 3D editor with the Asset Browser open in Place mode and an asset preview in the viewport.")
...
@Image(source: "PlacementModes.png",
       alt: "Asset Placer placement modes: Free, Grid, Surface, Vertex, and Spline.")
...
Select a category below to see its screenshot and matching reference notes. Keeping
the action panels and their content together in tabs makes the taller Paint and
Transform references easier to scan without lengthening the page unnecessarily.

@TabNavigator {
    @Tab("Place") {
        @Image(source: "PlaceAction.png",
               alt: "Asset Placer Place action settings, including scene unpacking, grid, height, scroll wheel, and Asset Zoo controls.")
    ...
    @Tab("Transform") {
        @Image(source: "TransformAction.png",
               alt: "Asset Placer Transform action settings for rotation, flips, randomization, scale, and reset controls.")
    ...
    @Tab("Paint") {
        @Image(source: "PaintAction.png",
               alt: "Asset Placer Paint action settings for repeated placement, scattering, volumetric brushes, masks, MultiMesh, and collision generation.")
    ...
    @Tab("Material") {
        @Image(source: "MaterialAction.png",
               alt: "Asset Placer Material action settings for overriding and applying materials.")
    ...
    @Tab("Collision") {
        @Image(source: "CollisionAction.png",
               alt: "Asset Placer Collision action settings for adding collision, choosing a body type, and choosing a shape type.")
    ...
    @Tab("Spline") {
        @Image(source: "SplineAction.png",
               alt: "Asset Placer Spline action settings for editing splines, terrain snapping, layers, and baking to nodes.")
