...
- Preview builds are currently based on Godot 4.5.
- C# / .NET is not supported.
- The Profiler detail page is incomplete.
- The Inspector has not yet been fully styled for macOS.
- Export templates are not currently included. At this stage, only Mac, iOS, and iPadOS deployments are supported.
